...
import Sec2_2 from './section2_right';
import Sec3 from './section3';
import Sec4 from './section4';
import Sec6 from './section6';

import img from './sygnet.png';
...
function App() {
 ...
 const nav = [
   {title: 'About us', lien:'#About',},
   {title: 'Career', lien: '#Career'},
   {title: 'Departement' , lien: '#Departement', subelement: [
                                            {title:'Marketing &amp; PR', lien:"#"},
                                            {title:'Customer Success &amp; Sales', lien:'#'},
                                            {title:'IT, Product, Design &amp; UX, Data', lien:'#'},
                                            {title:'Finance &amp; Administration', lien:'#'},
                                            {title:'HR &amp; more', lien:'#'},
